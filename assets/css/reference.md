...
/* Or: color(display-p3 1 0.2 0.1) for P3. */
...
/* Runtime. Updates when --brand changes. */
...
/* <button popovertarget="menu"> ... <div popover> */
#menu[popover] {
  position: absolute;
  margin: 0.25rem 0;
}
/* Toggle, light dismiss, ESC: built in. */
...
/* oklch: L is perceptually uniform across hues */
:root {
...
/* Standard; -webkit- prefix still needed. */
...
Page transitions used to need s transition library or React Transition Group. The View Transitions API gives you cross-fades and shared-element motion with one JS call and CSS. */
// JS: wrap DOM update
...
/* Fallback visible immediately, then swap */
...
/* Browser handles form controls, scrollbars, canvas */
...
/* Specificity 0. .list { padding: 0 } wins. */
