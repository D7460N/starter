...
**AutoCSS Architecture:** serves the JSON data-layer contract — permitted contents, shapes, and how data presence drives the UI. Canonical rules: https://github.com/Autocss-com/ai/blob/main/AGENTS.md
