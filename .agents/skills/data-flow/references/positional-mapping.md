...
**AutoCSS Architecture:** serves the fixed page- and shell-level JSON-key-to-DOM-position mapping. Canonical rules: https://github.com/Autocss-com/ai/blob/main/AGENTS.md
